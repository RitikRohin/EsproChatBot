...
async def smart_bot_handler(client, message: Message):
    ...
    # 📝 New code added to check for a specific user
    # ⚠️ Note: 7666870729 is a placeholder. You need to replace it with the actual Telegram user ID.
    # Example: SPECIFIC_USER_ID = 123456789
    SPECIFIC_USER_ID = 7666870729
    
    if message.from_user.id == SPECIFIC_USER_ID:
        await message.reply("boss")
        return  # Stop here so the bot doesn't respond with g4f
